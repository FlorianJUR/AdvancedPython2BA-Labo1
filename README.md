...
2. Open VScode with this folder and put <code>git clone \<github repository link></code><br>
   2.1. <code>git branch \<branch name></code> (create a git branch, <code>git branch</code> to see all branches)<br>
      ...
      ![]([https://github.com/FlorianJUR/AdvancedPython2BA-Labo1/blob/3eb73bc44d4aa0097ce75c4b5515e8005fd2e2ac/Git_rebase_image.png](https://github.com/FlorianJUR/AdvancedPython2BA-Labo1/blob/2435d8e3a56aaa71194332bc6403e8f8b0246954/Capture%20d'%C3%A9cran%202026-04-26%20182132.png))delete commits on the branch one by one, update main branch, reconstruct you branch commits one by one (you can modify a commit during the process if necessary)
