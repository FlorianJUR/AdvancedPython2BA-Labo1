...
2.1 <code>git branch <branch name></code> (create a git branch, <code>git branch</code> to see all branches)
...
4.1 <code>git checkout main</code> (we go on main)
...
5 <code>git pull</code> (take the last push, by default main)
